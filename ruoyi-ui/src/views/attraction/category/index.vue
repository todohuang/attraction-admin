...
<script>
import { listCategory, getCategory, delCategory, addCategory, updateCategory } from "@/api/attraction/category";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除POI分类编号为"' + ids + '"的数据项？').then(function() {
